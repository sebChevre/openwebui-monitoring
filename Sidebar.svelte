				...
				<div class="pb-1.5">
					...
					<div class="px-[0.4375rem] flex justify-center text-gray-800 dark:text-gray-200">
						...
						>
							...
							<div class="flex self-center translate-y-[0.5px]">
								<div class=" self-center text-sm font-primary">Monitoring</div>
							</div>
						</a>
					</div>
				</div>
			...
			<div class="px-1.5 pt-1.5 pb-2 sticky bottom-0 z-10 -mt-3 sidebar">
				...
				<div class="flex flex-col font-primary">
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						class="flex items-center rounded-2xl py-2 px-1.5 w-full hover:bg-gray-100/50 dark:hover:bg-gray-900/50 transition mb-1.5"
					...
					>
						<div class="self-center mr-3">
							<svg
								...
								xmlns="http://www.w3.org/2000/svg"
							>
								<path d="M3 3v18h18V3H3zm2 2h14v12H5V5zm0 14v-2h14v2H5z" />
								<circle cx="11" cy="13" r="2" />
								<path d="M7 11h2v4H7zm8-2h2v6h-2z" />
							</svg>
						</div>
						<div class="self-center font-medium text-sm truncate">Monitoring</div>
					</a>
